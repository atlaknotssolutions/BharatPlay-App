...
//       // ========== FIXED AVATAR UPLOAD (React Native style) ==========
//       if (avatarUri) {
//         const sourceFilename =
//           avatarAsset?.fileName ||
//           avatarUri.split("/").pop()?.split("?")[0] ||
//           "avatar.jpg";
//         const sourceExtension =
//           /\.(jpg|jpeg|png|webp)$/i.exec(sourceFilename)?.[1]?.toLowerCase() ||
//           "jpg";
//         const extension = sourceExtension === "jpeg" ? "jpg" : sourceExtension;
//         const filename = `avatar.${extension}`;
//         const type = avatarAsset?.mimeType?.startsWith("image/")
...
//           // Content-Type mat do — FormData automatically set karega
//         },
//         body: formData,
//       });
...
//       const savedAvatarUrl = data.avatarUrl || data.user?.avatar;
//       if (avatarUri && !savedAvatarUrl) {
//         throw new Error("Image uploaded, but ImageKit URL was not returned");
//       }
...
//         avatar: getMediaUrl(savedAvatarUrl) || prev.avatar,
...
//                 <Image
//                   source={{ uri: getAvatarSource(avatarUri || user.avatar) }}
